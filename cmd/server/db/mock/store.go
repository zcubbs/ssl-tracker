...
// Source: github.com/zcubbs/ssl-tracker/cmd/server/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination db/mock/store.go github.com/zcubbs/ssl-tracker/cmd/server/db/sqlc Store
//
